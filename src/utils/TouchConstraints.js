...
module.exports = TouchConstraint;
...
const canCollide = (body, mouse, mouseConstraint) =>
  ...
  Detector.canCollide(
    ...
    TouchConstraint.create = function(engine, options) {
      let mouse =
    ...
    TouchConstraint.update = function(mouseConstraint, bodies) {
    ...
    TouchConstraint._triggerEvents = function(mouseConstraint) {
