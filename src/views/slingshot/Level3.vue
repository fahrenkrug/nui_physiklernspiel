...
export default {
    ...
    methods: {
        ...
        setupWorld() {
            ...
            //add bodies C
            var target_3 = Bodies.rectangle(810, 315, 100, 20, {
                isStatic: true,
                id: 5,
            });
            var target_3v = Bodies.rectangle(860, 300, 20, 50, {
                isStatic: true,
            });
            var target_3v2 = Bodies.rectangle(760, 300, 20, 50, {
                isStatic: true,
            });

            //create CompoundBodies from the targetBodies
            ...
            this.compoundBodyC = Body.create({
                parts: [target_3, target_3v, target_3v2],
                isStatic: true,
                color: this.blue,
                id: 5,
            });
        ...
        isGoalPair(pair) {
            ...
            if ((pair.bodyA.id === this.ball.id && pair.bodyB.id === this.compoundBodyC.id) || (pair.bodyB.id === this.ball.id && pair.bodyA.id === this.compoundBodyC.id)) {
                console.log("hit registered C");
                return true;
            }
        },
